<?
    ...
    require_once('inc/header.php');
      ...
      else
      {
        ...
        if(!empty($_GET['id']) and is_numeric($_GET['id']) and $contacts->isValidContactId($_GET['id']))
        {
            ...
            ?>
                <div class="header editHeader">
                  ...
                  <ul class="nav nav-pills pull-right">
                    ...
                    <li><a class="btn btn-success"id="save" href="#">Save</a></li>
                  </ul> 
                </div>
                ...
                <div class="row-fluid">
                    ...
                    <form id="editContact" method="POST" action='aj.php?action=addContact' enctype="multipart/form-data">
                                ...
                                <input class="form-control" id="imageUpload" name="image" type="file" class="form-control">
                                <div>
                                    <div class="formLabel">
                                        <span >Name:</span>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div id="phones">
                                      ...
                                      ?>
                                          <div class="detailBox">
                                          <select  class="form-inline form-control" name="phoneType[]">
                                            ...
                                            <input name="phone[]" type="text" class=" form-inline form-control" placeholder="Phone" value="<?=$phone['p_number']?>">
                                            <button data-type="phone" class="remove btn btn-warning btn-block" onclick='removeDetailBox(this, event)'>Remove</button>
                    ...
                    <div id="deleteForm">
                      <form action="aj.php?action=deleteContact" method="post">
                        <input class="hide" name="ContactID" value="<?=$cDetails['c_id']?>">
